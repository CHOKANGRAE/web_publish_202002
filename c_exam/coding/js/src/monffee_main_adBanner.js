...
(function($){
	...
	slideGo();
	//adBannerBox.on('mouseenter', function(){ slideStop() });
	//adBannerBox.on('mouseleave', function(){ slideGo() });

	//adBannerBox.on('mouseenter', slideStop);
	//adBannerBox.on('mouseleave', slideGo );

	adBannerBox.on({mouseenter:slideStop, mouseleave: slideGo});
